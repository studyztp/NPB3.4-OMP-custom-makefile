...
omp_parallel:                                     ; preds = %omp_parallel.loopexit, %0
  ...
  store i32 14000, ptr @_QMcg_dataElastrow, align 4, !tbaa !13
  store i32 1, ptr @_QMcg_dataEfirstcol, align 4, !tbaa !15
  store i32 14000, ptr @_QMcg_dataElastcol, align 4, !tbaa !17
  %.unpack = load i8, ptr @_QQclX41, align 1, !tbaa !19
  ...
  %60 = call i1 @_FortranAioOutputInteger32(ptr %59, i32 14000)
  ...
  %63 = call i1 @_FortranAioOutputInteger32(ptr %62, i32 15)
  ...
  store i32 14000, ptr @_QMcg_dataEnaa, align 4, !tbaa !21
  store i32 2016000, ptr @_QMcg_dataEnzz, align 4, !tbaa !23
...
79:                                               ; preds = %omp_parallel, %omp_parallel207
  %80 = phi i64 [ 15, %omp_parallel ], [ %93, %omp_parallel207 ]
...
100:                                              ; preds = %95
  ...
  %102 = fadd contract double %101, 0xC031215715A1D8EC
  %103 = call contract double @llvm.fabs.f64(double %102)
  %104 = fdiv contract double %103, 0x4031215715A1D8EC
...
115:                                              ; preds = %100
  ...
  %123 = call i1 @_FortranAioOutputReal64(ptr %122, double 0x4031215715A1D8EC)
  br label %132
...
132:                                              ; preds = %106, %115, %124
  ...
  %135 = fdiv contract double 1.496460e+03, %96
  ...
  store i32 14000, ptr %23, align 4, !tbaa !4
...
switch.early.test:                                ; preds = %omp.master.region
  switch i32 %.fr91, label %omp.region.cont113 [
    i32 15, label %omp.master.region114
...
omp.master.region114:                             ; preds = %switch.early.test, %switch.early.test, %omp.master.region
  ...
  %76 = fadd contract double %75, 2.000000e+01
...
omp.par.entry50:
  ...
  store i32 14000, ptr %p.upperbound73, align 4
...
omp_loop.exit:                                    ; preds = %omp.wsloop.region10, %omp.par.entry
  ...
  store i32 14000, ptr %p.upperbound26, align 4
...
.lr.ph28:                                         ; preds = %45
  %57 = getelementptr inbounds i8, ptr %25, i64 88
  %58 = getelementptr inbounds i8, ptr %20, i64 44
  %invariant.gep = getelementptr i8, ptr %10, i64 -48
  %invariant.gep23 = getelementptr i8, ptr %11, i64 -96
  %narrow = add nuw i32 %spec.store.select, 1
  %59 = zext i32 %narrow to i64
  br label %60

60:                                               ; preds = %.lr.ph28, %.loopexit
  %indvars.iv35 = phi i64 [ 1, %.lr.ph28 ], [ %indvars.iv.next36, %.loopexit ]
  store i32 11, ptr %24, align 4, !tbaa !126
  call void @sprnvc_(ptr nonnull %0, ptr nonnull %24, ptr nonnull %22, ptr nonnull %25, ptr nonnull %20)
  %61 = load i32, ptr %19, align 4, !tbaa !126
  %62 = sext i32 %61 to i64
  %.not = icmp slt i64 %indvars.iv35, %62
  br i1 %.not, label %.loopexit, label %.outer.i

.outer.i:                                         ; preds = %60, %.thread.i
  %indvars.iv.ph.i = phi i64 [ %indvars.iv.next9.i, %.thread.i ], [ 1, %60 ]
  %63 = phi i1 [ false, %.thread.i ], [ true, %60 ]
  br label %64

64:                                               ; preds = %70, %.outer.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %70 ], [ %indvars.iv.ph.i, %.outer.i ]
  %65 = add nsw i64 %indvars.iv.i, -1
  %66 = getelementptr i32, ptr %20, i64 %65
  %67 = load i32, ptr %66, align 4, !tbaa !127
  %68 = zext i32 %67 to i64
  %69 = icmp eq i64 %indvars.iv35, %68
...
.thread.i:                                        ; preds = %64
  %71 = getelementptr double, ptr %25, i64 %65
  store double 5.000000e-01, ptr %71, align 8, !tbaa !133
  %indvars.iv.next9.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not10.i = icmp eq i64 %indvars.iv.next9.i, 12
  br i1 %exitcond.not10.i, label %.lr.ph, label %.outer.i

._crit_edge.i:                                    ; preds = %70
  br i1 %63, label %._crit_edge.thread.i, label %.lr.ph

._crit_edge.thread.i:                             ; preds = %._crit_edge.i
  store i32 12, ptr %24, align 4, !tbaa !135
  store double 5.000000e-01, ptr %57, align 8, !tbaa !133
  %72 = trunc nuw nsw i64 %indvars.iv35 to i32
  store i32 %72, ptr %58, align 4, !tbaa !127
  br label %.lr.ph

.lr.ph:                                           ; preds = %.thread.i, %._crit_edge.thread.i, %._crit_edge.i
  %73 = phi i32 [ 11, %._crit_edge.i ], [ 12, %._crit_edge.thread.i ], [ 11, %.thread.i ]
  %gep26 = getelementptr i32, ptr %invariant.gep25, i64 %indvars.iv35
  store i32 %73, ptr %gep26, align 4, !tbaa !137
  %74 = mul nuw nsw i64 %indvars.iv35, 12
  %gep = getelementptr i32, ptr %invariant.gep, i64 %74
  %gep24 = getelementptr double, ptr %invariant.gep23, i64 %74
  %narrow39 = add nuw nsw i32 %73, 1
  %75 = zext nneg i32 %narrow39 to i64
  br label %76

76:                                               ; preds = %.lr.ph, %76
  %indvars.iv = phi i64 [ 1, %.lr.ph ], [ %indvars.iv.next, %76 ]
  %77 = add nsw i64 %indvars.iv, -1
  %78 = getelementptr i32, ptr %20, i64 %77
  %79 = load i32, ptr %78, align 4, !tbaa !126
  %80 = getelementptr i32, ptr %gep, i64 %77
  store i32 %79, ptr %80, align 4, !tbaa !139
  %81 = getelementptr double, ptr %25, i64 %77
  %82 = load double, ptr %81, align 8, !tbaa !126
  %83 = getelementptr double, ptr %gep24, i64 %77
  store double %82, ptr %83, align 8, !tbaa !141
...
.loopexit:                                        ; preds = %76, %60
  ...
  br i1 %exitcond38.not, label %._crit_edge, label %60

._crit_edge:                                      ; preds = %.loopexit, %45
  tail call void @__kmpc_barrier(ptr nonnull @2, i32 %omp_global_thread_num4)
  %84 = load i32, ptr %1, align 4, !tbaa !143
  %85 = add i32 %84, 1
  %86 = sext i32 %85 to i64
  %87 = getelementptr i32, ptr %13, i64 %86
  %88 = getelementptr i8, ptr %87, i64 -4
  store i32 11, ptr %17, align 4, !tbaa !126
  store double 1.000000e-01, ptr %16, align 8, !tbaa !126
  store double 2.000000e+01, ptr %15, align 8, !tbaa !126
  call void @sparse_(ptr %2, ptr %3, ptr %4, ptr nonnull %0, ptr nonnull %1, ptr nonnull %17, ptr %9, ptr %10, ptr %11, ptr %5, ptr %6, ptr %12, ptr %13, ptr %88, ptr nonnull %16, ptr nonnull %15)
  ret void
}
...
define void @sparse_(ptr nocapture writeonly %0, ptr nocapture writeonly %1, ptr nocapture %2, ptr nocapture readonly %3, ptr nocapture readonly %4, ptr nocapture readonly %5, ptr nocapture readonly %6, ptr nocapture readonly %7, ptr nocapture readonly %8, ptr nocapture readonly %9, ptr nocapture readonly %10, ptr nocapture %11, ptr nocapture %12, ptr nocapture %13, ptr nocapture readonly %14, ptr nocapture readonly %15) local_unnamed_addr #0 {
  ...
  %21 = load i32, ptr %5, align 4, !tbaa !145
  %22 = add i32 %21, 1
  %23 = tail call i32 @llvm.smax.i32(i32 %22, i32 0)
  %24 = zext nneg i32 %23 to i64
  %25 = load i32, ptr %10, align 4, !tbaa !151
  %26 = load i32, ptr %9, align 4, !tbaa !153
  %27 = sub i32 %25, %26
  %28 = load i32, ptr %18, align 4, !tbaa !155
  %29 = add i32 %28, 1
  %30 = load i32, ptr %17, align 4, !tbaa !155
  %31 = add i32 %30, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> zeroinitializer, ptr %45, align 4, !tbaa !156
  store <4 x i32> zeroinitializer, ptr %46, align 4, !tbaa !156
  %index.next = add nuw i64 %index, 8
  %47 = icmp eq i64 %index.next, %n.vec
  br i1 %47, label %middle.block, label %vector.body, !llvm.loop !158
...
.lr.ph:                                           ; preds = %.lr.ph.preheader601, %.lr.ph
  ...
  store i32 0, ptr %gep, align 4, !tbaa !156
  %51 = add i32 %49, 1
  %52 = add nsw i64 %48, -1
  %53 = icmp ugt i64 %48, 1
  br i1 %53, label %.lr.ph, label %._crit_edge, !llvm.loop !159
...
64:                                               ; preds = %.lr.ph210, %76
  ...
  %65 = load i32, ptr %gep213, align 4, !tbaa !164
  %66 = load i32, ptr %18, align 4, !tbaa !155
  %67 = icmp sge i32 %65, %66
  %68 = load i32, ptr %17, align 4, !tbaa !155
...
71:                                               ; preds = %64
  ...
  %74 = load i32, ptr %gep208, align 4, !tbaa !156
  %75 = add i32 %74, %60
  store i32 %75, ptr %gep208, align 4, !tbaa !156
  br label %76
...
._crit_edge218:                                   ; preds = %._crit_edge211, %._crit_edge
  %77 = load i32, ptr %19, align 4, !tbaa !155
  %78 = icmp eq i32 %77, 0
...
.lr.ph224.preheader:                              ; preds = %80
  ...
  %.pre = load i32, ptr %gep222.phi.trans.insert, align 4, !tbaa !156
  br label %.lr.ph224
...
.lr.ph224:                                        ; preds = %.lr.ph224.preheader, %.lr.ph224
  ...
  %90 = load i32, ptr %gep220, align 4, !tbaa !156
  %91 = add i32 %86, %90
  store i32 %91, ptr %gep220, align 4, !tbaa !156
  %92 = add i32 %88, 1
  %93 = add nsw i64 %87, -1
...
._crit_edge225:                                   ; preds = %.lr.ph224, %80
  %95 = load i32, ptr %19, align 4, !tbaa !155
  %96 = load i32, ptr %20, align 4, !tbaa !155
...
98:                                               ; preds = %._crit_edge225
  ...
  store i32 %101, ptr %103, align 4, !tbaa !166
  br label %104

104:                                              ; preds = %98, %._crit_edge225
  tail call void @__kmpc_barrier(ptr nonnull @2, i32 %omp_global_thread_num36)
  %105 = load i32, ptr %19, align 4, !tbaa !155
  %106 = load i32, ptr %20, align 4, !tbaa !155
...
vector.body432:                                   ; preds = %vector.body432, %vector.ph425
  ...
  %wide.load = load <4 x i32>, ptr %114, align 4, !tbaa !166
  %wide.load435 = load <4 x i32>, ptr %115, align 4, !tbaa !166
  ...
  br i1 %118, label %middle.block422, label %vector.body432, !llvm.loop !169
...
.lr.ph228:                                        ; preds = %.lr.ph228.preheader596, %.lr.ph228
  ...
  br i1 %125, label %.lr.ph228, label %._crit_edge229, !llvm.loop !170
...
vector.body450:                                   ; preds = %vector.body450, %vector.ph441
  ...
  %wide.load454 = load <4 x i32>, ptr %138, align 4, !tbaa !156
  %wide.load455 = load <4 x i32>, ptr %139, align 4, !tbaa !156
  %140 = add <4 x i32> %wide.load454, %broadcast.splat
  %141 = add <4 x i32> %wide.load455, %broadcast.splat
  store <4 x i32> %140, ptr %138, align 4, !tbaa !156
  store <4 x i32> %141, ptr %139, align 4, !tbaa !156
  %index.next456 = add nuw i64 %index451, 8
  %142 = icmp eq i64 %index.next456, %n.vec443
  br i1 %142, label %middle.block438, label %vector.body450, !llvm.loop !171
...
.lr.ph233:                                        ; preds = %.lr.ph233.preheader593, %.lr.ph233
  ...
  %146 = load i32, ptr %gep231, align 4, !tbaa !156
  %147 = add i32 %146, %.lcssa416
  store i32 %147, ptr %gep231, align 4, !tbaa !156
  %148 = add i32 %144, 1
  %149 = add nsw i64 %143, -1
  %150 = icmp ugt i64 %143, 1
  br i1 %150, label %.lr.ph233, label %.thread, !llvm.loop !172
...
.thread:                                          ; preds = %.lr.ph233, %middle.block438, %127, %104, %._crit_edge229
  ...
  %156 = add i32 %155, -1
  %157 = load i32, ptr %4, align 4, !tbaa !173
...
omp.master.region:                                ; preds = %159
  ...
  %167 = load i32, ptr %4, align 4, !tbaa !173
...
171:                                              ; preds = %.thread
  %172 = load i32, ptr %18, align 4, !tbaa !155
  %173 = sext i32 %172 to i64
  %174 = load i32, ptr %17, align 4, !tbaa !155
...
.lr.ph240:                                        ; preds = %.lr.ph240.preheader, %._crit_edge236
  ...
  %187 = load i32, ptr %gep238, align 4, !tbaa !156
  %188 = add i32 %187, -1
...
vector.body472:                                   ; preds = %vector.body472, %vector.ph463
  ...
  store <4 x double> zeroinitializer, ptr %202, align 8, !tbaa !175
  store <4 x double> zeroinitializer, ptr %203, align 8, !tbaa !175
  %204 = getelementptr i32, ptr %12, i64 %201
  %205 = getelementptr i8, ptr %204, i64 16
  store <4 x i32> zeroinitializer, ptr %204, align 4, !tbaa !177
  store <4 x i32> zeroinitializer, ptr %205, align 4, !tbaa !177
  %index.next476 = add nuw i64 %index473, 8
  %206 = icmp eq i64 %index.next476, %n.vec465
  br i1 %206, label %middle.block460, label %vector.body472, !llvm.loop !179
...
.lr.ph235:                                        ; preds = %.lr.ph235.preheader590, %.lr.ph235
  ...
  store double 0.000000e+00, ptr %211, align 8, !tbaa !175
  %212 = getelementptr i32, ptr %12, i64 %210
  store i32 0, ptr %212, align 4, !tbaa !177
  %213 = add i32 %208, 1
  %214 = add nsw i64 %207, -1
  %215 = icmp ugt i64 %207, 1
  br i1 %215, label %.lr.ph235, label %._crit_edge236, !llvm.loop !180

._crit_edge236:                                   ; preds = %.lr.ph235, %middle.block460, %.lr.ph240
  %216 = getelementptr i32, ptr %13, i64 %181
  store i32 0, ptr %216, align 4, !tbaa !181
...
._crit_edge241:                                   ; preds = %._crit_edge236, %171
  %219 = load double, ptr %14, align 8, !tbaa !183
  %220 = load i32, ptr %3, align 4, !tbaa !160
...
234:                                              ; preds = %..loopexit_crit_edge.split.us.us, %.lr.ph273
  ...
  %238 = load i32, ptr %18, align 4, !tbaa !155
  %239 = icmp sge i32 %237, %238
  %240 = load i32, ptr %17, align 4, !tbaa !155
...
.lr.ph260.us:                                     ; preds = %234
  ...
  %253 = load i32, ptr %gep256.us, align 4, !tbaa !156
  %254 = sub i32 %253, %250
...
.lr.ph260.split.us.us:                            ; preds = %.lr.ph260.us, %297
  ...
  %262 = load i32, ptr %261, align 4, !tbaa !164
  %263 = getelementptr double, ptr %8, i64 %260
  %264 = load double, ptr %263, align 8, !tbaa !185
...
268:                                              ; preds = %.lr.ph260.split.us.us
  ...
  %270 = load double, ptr %15, align 8, !tbaa !187
...
272:                                              ; preds = %282, %.lr.ph247.us.us
  ...
  %276 = load i32, ptr %275, align 4, !tbaa !177
...
286:                                              ; preds = %280
  %287 = load i32, ptr %256, align 4, !tbaa !181
  %288 = add i32 %287, 1
  store i32 %288, ptr %256, align 4, !tbaa !181
  br label %297

289:                                              ; preds = %278
  %290 = getelementptr i32, ptr %12, i64 %274
  store i32 %262, ptr %290, align 4, !tbaa !177
  br label %297
...
._crit_edge254.us.us:                             ; preds = %316, %291
  store i32 %262, ptr %292, align 4, !tbaa !177
  %296 = getelementptr double, ptr %11, i64 %274
  store double 0.000000e+00, ptr %296, align 8, !tbaa !175
  br label %297

297:                                              ; preds = %._crit_edge254.us.us, %289, %286
  %298 = getelementptr double, ptr %11, i64 %274
  %299 = load double, ptr %298, align 8, !tbaa !175
  %300 = fadd contract double %.0.us.us, %299
  store double %300, ptr %298, align 8, !tbaa !175
...
308:                                              ; preds = %.lr.ph253.us.us
  ...
  %310 = load double, ptr %309, align 8, !tbaa !175
  %311 = add i32 %302, 1
  %312 = sext i32 %311 to i64
  %313 = add nsw i64 %312, -1
  %314 = getelementptr double, ptr %11, i64 %313
  store double %310, ptr %314, align 8, !tbaa !175
  %315 = getelementptr i32, ptr %12, i64 %313
  store i32 %306, ptr %315, align 4, !tbaa !177
  br label %316
...
._crit_edge287:                                   ; preds = %._crit_edge274, %._crit_edge241
  tail call void @__kmpc_barrier(ptr nonnull @2, i32 %omp_global_thread_num36)
  %326 = load i32, ptr %18, align 4, !tbaa !155
  %327 = add i32 %326, 1
  %328 = sext i32 %327 to i64
  %329 = load i32, ptr %17, align 4, !tbaa !155
...
.lr.ph293.preheader:                              ; preds = %._crit_edge287
  ...
  %.pre373 = load i32, ptr %gep291.phi.trans.insert, align 4, !tbaa !181
  br label %.lr.ph293
...
.lr.ph293:                                        ; preds = %.lr.ph293.preheader, %.lr.ph293
  ...
  %337 = load i32, ptr %gep289, align 4, !tbaa !181
  %338 = add i32 %333, %337
  store i32 %338, ptr %gep289, align 4, !tbaa !181
  %339 = add i32 %335, 1
...
._crit_edge294:                                   ; preds = %.lr.ph293, %._crit_edge287
  %342 = load i32, ptr %19, align 4, !tbaa !155
  %343 = load i32, ptr %20, align 4, !tbaa !155
  %344 = icmp slt i32 %342, %343
  br i1 %344, label %345, label %353

345:                                              ; preds = %._crit_edge294
  %346 = load i32, ptr %17, align 4, !tbaa !155
  %347 = sext i32 %346 to i64
  %348 = getelementptr i32, ptr %13, i64 %347
  %349 = getelementptr i8, ptr %348, i64 -4
  %350 = load i32, ptr %349, align 4, !tbaa !181
  %351 = sext i32 %342 to i64
  %352 = getelementptr i32, ptr @_QMtinfoElast_n, i64 %351
  store i32 %350, ptr %352, align 4, !tbaa !166
  br label %353

353:                                              ; preds = %345, %._crit_edge294
  tail call void @__kmpc_barrier(ptr nonnull @2, i32 %omp_global_thread_num36)
  %354 = load i32, ptr %19, align 4, !tbaa !155
  %355 = load i32, ptr %20, align 4, !tbaa !155
...
vector.body488:                                   ; preds = %vector.body488, %vector.ph481
  ...
  %wide.load492 = load <4 x i32>, ptr %363, align 4, !tbaa !166
  %wide.load493 = load <4 x i32>, ptr %364, align 4, !tbaa !166
  ...
  br i1 %367, label %middle.block478, label %vector.body488, !llvm.loop !189
...
.lr.ph297:                                        ; preds = %.lr.ph297.preheader573, %.lr.ph297
  ...
  %371 = load i32, ptr %370, align 4, !tbaa !166
  %372 = add i32 %371, %.3295
  %indvars.iv.next368 = add nuw nsw i64 %indvars.iv367, 1
  %373 = add nsw i64 %369, -1
  %374 = icmp ugt i64 %369, 1
  br i1 %374, label %.lr.ph297, label %._crit_edge298, !llvm.loop !190
...
376:                                              ; preds = %._crit_edge298
  %377 = load i32, ptr %18, align 4, !tbaa !155
  %378 = sext i32 %377 to i64
  %379 = load i32, ptr %17, align 4, !tbaa !155
...
vector.body512:                                   ; preds = %vector.body512, %vector.ph503
  ...
  %wide.load516 = load <4 x i32>, ptr %392, align 4, !tbaa !181
  %wide.load517 = load <4 x i32>, ptr %393, align 4, !tbaa !181
  %394 = add <4 x i32> %wide.load516, %broadcast.splat519
  %395 = add <4 x i32> %wide.load517, %broadcast.splat519
  store <4 x i32> %394, ptr %392, align 4, !tbaa !181
  store <4 x i32> %395, ptr %393, align 4, !tbaa !181
  %index.next520 = add nuw i64 %index513, 8
  %396 = icmp eq i64 %index.next520, %n.vec505
  br i1 %396, label %middle.block500, label %vector.body512, !llvm.loop !191
...
.lr.ph303:                                        ; preds = %.lr.ph303.preheader570, %.lr.ph303
  ...
  %400 = load i32, ptr %gep301, align 4, !tbaa !181
  %401 = add i32 %400, %.lcssa
  store i32 %401, ptr %gep301, align 4, !tbaa !181
  %402 = add i32 %398, 1
  %403 = add nsw i64 %397, -1
  %404 = icmp ugt i64 %397, 1
  br i1 %404, label %.lr.ph303, label %omp_loop.preheader, !llvm.loop !192
...
omp.wsloop.region13:                              ; preds = %omp.wsloop.region13.preheader568, %omp.wsloop.region13
  ...
  %417 = load double, ptr %416, align 8, !tbaa !175
  %418 = sext i32 %413 to i64
  %419 = add nsw i64 %418, -1
  %420 = getelementptr double, ptr %0, i64 %419
  store double %417, ptr %420, align 8, !tbaa !193
  %421 = getelementptr i32, ptr %12, i64 %415
  %422 = load i32, ptr %421, align 4, !tbaa !177
  %423 = getelementptr i32, ptr %1, i64 %419
  store i32 %422, ptr %423, align 4, !tbaa !195
  %424 = add i32 %.1154304, 1
  %425 = add i32 %413, 1
  %426 = add nsw i64 %412, -1
  %427 = icmp ugt i64 %412, 1
  br i1 %427, label %omp.wsloop.region13, label %omp.wsloop.region14, !llvm.loop !197
...
omp.wsloop.region13.preheader:                    ; preds = %omp.wsloop.region11
  ...
  %442 = load i32, ptr %441, align 4, !tbaa !156
...
vector.body539:                                   ; preds = %vector.body539, %vector.ph527
  ...
  %wide.load545 = load <4 x double>, ptr %457, align 8, !tbaa !175
  %458 = sext i32 %offset.idx542 to i64
  %459 = add nsw i64 %458, -1
  %460 = getelementptr double, ptr %0, i64 %459
  store <4 x double> %wide.load545, ptr %460, align 8, !tbaa !193
  %461 = getelementptr i32, ptr %12, i64 %456
  %wide.load546 = load <4 x i32>, ptr %461, align 4, !tbaa !177
  %462 = getelementptr i32, ptr %1, i64 %459
  store <4 x i32> %wide.load546, ptr %462, align 4, !tbaa !195
  %index.next547 = add nuw i64 %index540, 4
  %463 = icmp eq i64 %index.next547, %n.vec529
  br i1 %463, label %middle.block524, label %vector.body539, !llvm.loop !198
...
vector.body557:                                   ; preds = %vector.body557, %vector.ph552
  ...
  %wide.load559 = load <4 x i32>, ptr %485, align 4, !tbaa !156
  %wide.load560 = load <4 x i32>, ptr %486, align 4, !tbaa !156
  %487 = add i32 %482, 1
  %488 = sext i32 %487 to i64
  %489 = getelementptr i32, ptr %invariant.gep288, i64 %488
  %490 = getelementptr i8, ptr %489, i64 16
  %wide.load561 = load <4 x i32>, ptr %489, align 4, !tbaa !181
  %wide.load562 = load <4 x i32>, ptr %490, align 4, !tbaa !181
  %491 = sub <4 x i32> %wide.load559, %wide.load561
  %492 = sub <4 x i32> %wide.load560, %wide.load562
  store <4 x i32> %491, ptr %485, align 4, !tbaa !156
  store <4 x i32> %492, ptr %486, align 4, !tbaa !156
  %index.next563 = add nuw i32 %index558, 8
  %493 = icmp eq i32 %index.next563, %n.vec554
  br i1 %493, label %middle.block549, label %vector.body557, !llvm.loop !199
...
omp_loop.body21:                                  ; preds = %omp_loop.body21.preheader567, %omp_loop.body21
  ...
  %497 = load i32, ptr %gep314, align 4, !tbaa !156
  %498 = add i32 %494, 1
  %499 = sext i32 %498 to i64
  %gep316 = getelementptr i32, ptr %invariant.gep288, i64 %499
  %500 = load i32, ptr %gep316, align 4, !tbaa !181
  %501 = sub i32 %497, %500
  store i32 %501, ptr %gep314, align 4, !tbaa !156
  %omp_loop.next27 = add nuw i32 %omp_loop.iv25318, 1
  %exitcond371.not = icmp eq i32 %omp_loop.iv25318, %reass.sub325
  br i1 %exitcond371.not, label %omp_loop.exit23, label %omp_loop.body21, !llvm.loop !200
...
define void @sprnvc_(ptr nocapture readonly %0, ptr nocapture readonly %1, ptr nocapture readonly %2, ptr nocapture writeonly %3, ptr nocapture %4) local_unnamed_addr #0 {
  ...
  %8 = load i32, ptr %1, align 4, !tbaa !201
...
.lr.ph23.split.us:                                ; preds = %.lr.ph23, %.backedge.us
  ...
  %11 = load i32, ptr %2, align 4, !tbaa !207
  %12 = sitofp i32 %11 to double
  %13 = fmul contract double %10, %12
  %14 = fptosi double %13 to i32
  %15 = add i32 %14, 1
  %16 = load i32, ptr %0, align 4, !tbaa !213
...
.preheader.us:                                    ; preds = %.lr.ph23.split.us, %21
  ...
  %19 = load i32, ptr %gep.us, align 4, !tbaa !215
...
.backedge.us:                                     ; preds = %.preheader.us, %.lr.ph23.split.us
  %23 = load i32, ptr %1, align 4, !tbaa !201
...
.outer:                                           ; preds = %.lr.ph23.split, %21
  ...
  store double %.lcssa16, ptr %36, align 8, !tbaa !217
  %37 = getelementptr i32, ptr %4, i64 %indvars.iv43
  store i32 %.lcssa, ptr %37, align 4, !tbaa !215
  %38 = load i32, ptr %1, align 4, !tbaa !201
  %39 = sext i32 %38 to i64
...
define i32 @icnvrt_(ptr nocapture readonly %0, ptr nocapture readonly %1) local_unnamed_addr #2 {
  ...
  %5 = load double, ptr %0, align 8, !tbaa !219
...
.lr.ph:                                           ; preds = %6
  %9 = load i32, ptr %4, align 4, !tbaa !221
...
.thread:                                          ; preds = %12
  %18 = load double, ptr %5, align 8, !tbaa !223
...
; Function Attrs: nounwind
declare !callback !225 void @__kmpc_fork_call(ptr, i32, ptr, ...) local_unnamed_addr #4
...
!19 = !{!20, !20, i64 0}
!20 = !{!"global data/_QQclX41", !10, i64 0}
!21 = !{!22, !22, i64 0}
...
!143 = !{!144, !144, i64 0}
!144 = !{!"dummy arg data/_QFmakeaEnz", !122, i64 0}
!145 = !{!146, !146, i64 0}
!146 = !{!"dummy arg data/_QFsparseEnonzer", !147, i64 0}
!147 = !{!"dummy arg data", !148, i64 0}
!148 = !{!"any data access", !149, i64 0}
!149 = !{!"any access", !150, i64 0}
!150 = !{!"Flang function root _QPsparse"}
!151 = !{!152, !152, i64 0}
!152 = !{!"dummy arg data/_QFsparseElastrow", !147, i64 0}
!153 = !{!154, !154, i64 0}
!154 = !{!"dummy arg data/_QFsparseEfirstrow", !147, i64 0}
!155 = !{!148, !148, i64 0}
!156 = !{!157, !157, i64 0}
!157 = !{!"dummy arg data/_QFsparseErowstr", !147, i64 0}
!158 = distinct !{!158, !40, !41}
!159 = distinct !{!159, !40}
!160 = !{!161, !161, i64 0}
!161 = !{!"dummy arg data/_QFsparseEn", !147, i64 0}
!162 = !{!163, !163, i64 0}
!163 = !{!"dummy arg data/_QFsparseEarow", !147, i64 0}
!164 = !{!165, !165, i64 0}
!165 = !{!"dummy arg data/_QFsparseEacol", !147, i64 0}
!166 = !{!167, !167, i64 0}
!167 = !{!"global data/_QMtinfoElast_n", !168, i64 0}
!168 = !{!"global data", !148, i64 0}
!169 = distinct !{!169, !40, !41}
!170 = distinct !{!170, !41, !40}
!171 = distinct !{!171, !40, !41}
!172 = distinct !{!172, !40}
!173 = !{!174, !174, i64 0}
!174 = !{!"dummy arg data/_QFsparseEnz", !147, i64 0}
!175 = !{!176, !176, i64 0}
!176 = !{!"dummy arg data/_QFsparseEv", !147, i64 0}
!177 = !{!178, !178, i64 0}
!178 = !{!"dummy arg data/_QFsparseEiv", !147, i64 0}
!179 = distinct !{!179, !40, !41}
!180 = distinct !{!180, !40}
!181 = !{!182, !182, i64 0}
!182 = !{!"dummy arg data/_QFsparseEnzloc", !147, i64 0}
!183 = !{!184, !184, i64 0}
!184 = !{!"dummy arg data/_QFsparseErcond", !147, i64 0}
!185 = !{!186, !186, i64 0}
!186 = !{!"dummy arg data/_QFsparseEaelt", !147, i64 0}
!187 = !{!188, !188, i64 0}
!188 = !{!"dummy arg data/_QFsparseEshift", !147, i64 0}
!189 = distinct !{!189, !40, !41}
!190 = distinct !{!190, !41, !40}
!191 = distinct !{!191, !40, !41}
!192 = distinct !{!192, !40}
!193 = !{!194, !194, i64 0}
!194 = !{!"dummy arg data/_QFsparseEa", !147, i64 0}
!195 = !{!196, !196, i64 0}
!196 = !{!"dummy arg data/_QFsparseEcolidx", !147, i64 0}
!197 = distinct !{!197, !40}
!198 = distinct !{!198, !40, !41}
!199 = distinct !{!199, !40, !41}
!200 = distinct !{!200, !40}
!201 = !{!202, !202, i64 0}
!202 = !{!"dummy arg data/_QFsprnvcEnz", !203, i64 0}
!203 = !{!"dummy arg data", !204, i64 0}
!204 = !{!"any data access", !205, i64 0}
!205 = !{!"any access", !206, i64 0}
!206 = !{!"Flang function root _QPsprnvc"}
!207 = !{!208, !208, i64 0}
!208 = !{!"dummy arg data/_QFicnvrtEipwr2", !209, i64 0}
!209 = !{!"dummy arg data", !210, i64 0}
!210 = !{!"any data access", !211, i64 0}
!211 = !{!"any access", !212, i64 0}
!212 = !{!"Flang function root _QPicnvrt"}
!213 = !{!214, !214, i64 0}
!214 = !{!"dummy arg data/_QFsprnvcEn", !203, i64 0}
!215 = !{!216, !216, i64 0}
!216 = !{!"dummy arg data/_QFsprnvcEiv", !203, i64 0}
!217 = !{!218, !218, i64 0}
!218 = !{!"dummy arg data/_QFsprnvcEv", !203, i64 0}
!219 = !{!220, !220, i64 0}
!220 = !{!"dummy arg data/_QFicnvrtEx", !209, i64 0}
!221 = !{!222, !222, i64 0}
!222 = !{!"dummy arg data/_QFvecsetEi", !129, i64 0}
!223 = !{!224, !224, i64 0}
!224 = !{!"dummy arg data/_QFvecsetEval", !129, i64 0}
!225 = !{!226}
