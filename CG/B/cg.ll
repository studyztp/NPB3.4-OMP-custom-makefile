...
omp_parallel:                                     ; preds = %omp_parallel.loopexit, %0
  ...
  store i32 75000, ptr @_QMcg_dataElastrow, align 4, !tbaa !13
  store i32 1, ptr @_QMcg_dataEfirstcol, align 4, !tbaa !15
  store i32 75000, ptr @_QMcg_dataElastcol, align 4, !tbaa !17
  %.unpack = load i8, ptr @_QQclX42, align 1, !tbaa !19
  ...
  %60 = call i1 @_FortranAioOutputInteger32(ptr %59, i32 75000)
  ...
  store i32 75000, ptr @_QMcg_dataEnaa, align 4, !tbaa !21
  store i32 14700000, ptr @_QMcg_dataEnzz, align 4, !tbaa !23
...
100:                                              ; preds = %95
  ...
  %102 = fadd contract double %101, 0xC036B6767CEA459A
  %103 = call contract double @llvm.fabs.f64(double %102)
  %104 = fdiv contract double %103, 0x4036B6767CEA459A
...
115:                                              ; preds = %100
  ...
  %123 = call i1 @_FortranAioOutputReal64(ptr %122, double 0x4036B6767CEA459A)
  br label %132
...
132:                                              ; preds = %106, %115, %124
  ...
  %135 = fdiv contract double 0x40EAB697FFFFFFFF, %96
  ...
  store i32 75000, ptr %23, align 4, !tbaa !4
...
omp.master.region114:                             ; preds = %switch.early.test, %switch.early.test, %omp.master.region
  ...
  %76 = fadd contract double %75, 6.000000e+01
...
omp.par.entry50:
  ...
  store i32 75000, ptr %p.upperbound73, align 4
...
omp_loop.exit:                                    ; preds = %omp.wsloop.region10, %omp.par.entry
  ...
  store i32 75000, ptr %p.upperbound26, align 4
...
.lr.ph28:                                         ; preds = %45
  %57 = getelementptr inbounds i8, ptr %25, i64 104
  %58 = getelementptr inbounds i8, ptr %20, i64 52
  %invariant.gep = getelementptr i8, ptr %10, i64 -56
  %invariant.gep23 = getelementptr i8, ptr %11, i64 -112
...
60:                                               ; preds = %.lr.ph28, %.loopexit
  ...
  store i32 13, ptr %24, align 4, !tbaa !126
...
.thread.i:                                        ; preds = %64
  ...
  %exitcond.not10.i = icmp eq i64 %indvars.iv.next9.i, 14
...
._crit_edge.thread.i:                             ; preds = %._crit_edge.i
  store i32 14, ptr %24, align 4, !tbaa !135
...
._crit_edge:                                      ; preds = %.loopexit, %45
  ...
  store i32 13, ptr %17, align 4, !tbaa !126
  store double 1.000000e-01, ptr %16, align 8, !tbaa !126
  store double 6.000000e+01, ptr %15, align 8, !tbaa !126
...
!19 = !{!20, !20, i64 0}
!20 = !{!"global data/_QQclX42", !10, i64 0}
!21 = !{!22, !22, i64 0}
