...
@_QMcg_dataECkz = local_unnamed_addr constant i32 8
@_QMcg_dataElastcol = local_unnamed_addr global i32 0
@_QMcg_dataElastrow = local_unnamed_addr global i32 0
@_QMcg_dataECna = local_unnamed_addr constant i32 9000000
@_QMcg_dataEnaa = local_unnamed_addr global i32 0
@_QMcg_dataECnaz = local_unnamed_addr constant i64 243000000
@_QMcg_dataECniter = local_unnamed_addr constant i32 100
@_QMcg_dataECnonzer = local_unnamed_addr constant i32 26
@_QMcg_dataECnpbversion = local_unnamed_addr constant [5 x i8] c"3.4.2"
@_QMcg_dataECnz = local_unnamed_addr constant i64 6561000000
@_QMcg_dataEnzz = local_unnamed_addr global i64 0
...
@_QMcg_dataErowstr = global { ptr, i64, i32, i8, i8, i8, i8, [1 x [3 x i64]] } { ptr null, i64 ptrtoint (ptr getelementptr (i64, ptr null, i32 1) to i64), i32 20180515, i8 1, i8 10, i8 2, i8 0, [1 x [3 x i64]] [[3 x i64] [i64 1, i64 0, i64 ptrtoint (ptr getelementptr (i64, ptr null, i32 1) to i64)]] }
@_QMcg_dataECshift = local_unnamed_addr constant double 1.500000e+03
...
@_QMtinfoElast_n = local_unnamed_addr global [1025 x i64] zeroinitializer
...
define void @alloc_space_() local_unnamed_addr #0 {
  ...
  %3 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEcolidx, i32 0, i64 1, i64 6561000000)
...
6:                                                ; preds = %0
  %7 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataErowstr, i32 0, i64 1, i64 9000001)
...
10:                                               ; preds = %6
  %11 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEiv, i32 0, i64 1, i64 6570000000)
...
14:                                               ; preds = %10
  %15 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEarow, i32 0, i64 1, i64 9000000)
...
18:                                               ; preds = %14
  %19 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEacol, i32 0, i64 1, i64 243000000)
...
22:                                               ; preds = %18
  %23 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEv, i32 0, i64 1, i64 6561000000)
...
26:                                               ; preds = %22
  %27 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEaelt, i32 0, i64 1, i64 243000000)
...
30:                                               ; preds = %26
  %31 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEa, i32 0, i64 1, i64 6561000000)
...
34:                                               ; preds = %30
  %35 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEx, i32 0, i64 1, i64 9000002)
...
38:                                               ; preds = %34
  %39 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEz, i32 0, i64 1, i64 9000002)
...
42:                                               ; preds = %38
  %43 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEp, i32 0, i64 1, i64 9000002)
...
46:                                               ; preds = %42
  %47 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEq, i32 0, i64 1, i64 9000002)
...
50:                                               ; preds = %46
  %51 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMcg_dataEr, i32 0, i64 1, i64 9000002)
