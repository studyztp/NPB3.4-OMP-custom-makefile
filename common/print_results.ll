...
$_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65 = comdat any
...
@_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65 = linkonce constant [102 x i8] c"/scr/studyztp/experiments/hardware_profiling/gem5/NPB3.4-OMP-custom-makefile/common/print_results.f90\00", comdat
...
entry:
  ...
  %34 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXe19930870898b1ec58a1e308924da098, i64 37, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 32)
  %35 = call i1 @_FortranAioOutputAscii(ptr %34, ptr %0, i64 %19)
  %36 = call i32 @_FortranAioEndIoStatement(ptr %34)
  %37 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX7919783500b678075096608c12ca6e6f, i64 33, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 35)
...
47:                                               ; preds = %44
  %48 = call ptr @_FortranAioBeginInternalFormattedOutput(ptr nonnull %32, i64 15, ptr nonnull @_QQclX286631352E3029, i64 7, ptr null, ptr null, i64 0, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 45)
  ...
  %56 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX28272053697A652020202020202020202020203D20272C39782C2061313529, i64 31, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 48)
  %57 = call i1 @_FortranAioOutputAscii(ptr %56, ptr nonnull %32, i64 %spec.select)
  br label %70

58:                                               ; preds = %44
  %59 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX28272053697A652020202020202020202020203D20272C3132782C2069313229, i64 32, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 51)
  %60 = load i32, ptr %2, align 4, !tbaa !13
  %61 = call i1 @_FortranAioOutputInteger32(ptr %59, i32 %60)
  br label %70

62:                                               ; preds = %entry
  %63 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXe3a1e23b04750251dbc06349338db4fb, i64 45, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 55)
...
70:                                               ; preds = %47, %58, %62
  ...
  %72 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXf488e6fe6425733b75180e52e5729edc, i64 33, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 59)
  ...
  %76 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXa1c2bf91d970756dd56bdfc60d12ff2f, i64 34, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 62)
...
82:                                               ; preds = %70
  %83 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX67d0ac278b44cd755d1148ac300c1d8c, i64 33, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 65)
...
89:                                               ; preds = %87
  %90 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXdf40c4bd5154c5951f47109be404a9e9, i64 33, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 68)
...
95:                                               ; preds = %93
  %96 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXb31c53e949b780b69beb427a06e2a9a5, i64 56, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 71)
  %97 = call i32 @_FortranAioEndIoStatement(ptr %96)
  br label %98

98:                                               ; preds = %95, %93
  %99 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3ce1cd80a98b929c53b6d1b1762dfdf0, i64 34, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 74)
...
105:                                              ; preds = %98
  %106 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX3f05b3bd875754a1aa9fca54b5896b7e, i64 35, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 77)
...
114:                                              ; preds = %105, %98
  %115 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX2827204F7065726174696F6E207479706520203D20272C2061323429, i64 28, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 80)
...
119:                                              ; preds = %114
  %120 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720566572696669636174696F6E202020203D20272C203132782C206129, i64 31, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 84)
  %121 = call i1 @_FortranAioOutputAscii(ptr %120, ptr nonnull @_QQclX20205355434345535346554C, i64 12)
  br label %125

122:                                              ; preds = %114
  %123 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720566572696669636174696F6E202020203D20272C203132782C206129, i64 31, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 86)
...
125:                                              ; preds = %119, %122
  ...
  %127 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX7f7a534499813298534f45d0655a9f43, i64 33, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 90)
  %128 = call i1 @_FortranAioOutputAscii(ptr %127, ptr %10, i64 %22)
  %129 = call i32 @_FortranAioEndIoStatement(ptr %127)
  %130 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXdd4ec6d209782ab5bf14fb2987babcce, i64 33, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 93)
  %131 = call i1 @_FortranAioOutputAscii(ptr %130, ptr %11, i64 %23)
  %132 = call i32 @_FortranAioEndIoStatement(ptr %130)
  %133 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX1f51d49042e7689683328f2246bbaff1, i64 53, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 97)
  %134 = call i1 @_FortranAioOutputAscii(ptr %133, ptr %12, i64 %24)
  %135 = call i32 @_FortranAioEndIoStatement(ptr %133)
  %136 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720202020464C494E4B20202020202020203D20272C206129, i64 26, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 101)
  %137 = call i1 @_FortranAioOutputAscii(ptr %136, ptr %13, i64 %25)
  %138 = call i32 @_FortranAioEndIoStatement(ptr %136)
  %139 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720202020465F4C494220202020202020203D20272C206129, i64 26, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 104)
  %140 = call i1 @_FortranAioOutputAscii(ptr %139, ptr %14, i64 %26)
  %141 = call i32 @_FortranAioEndIoStatement(ptr %139)
  %142 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720202020465F494E4320202020202020203D20272C206129, i64 26, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 107)
  %143 = call i1 @_FortranAioOutputAscii(ptr %142, ptr %15, i64 %27)
  %144 = call i32 @_FortranAioEndIoStatement(ptr %142)
  %145 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX28272020202046464C414753202020202020203D20272C206129, i64 26, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 110)
  %146 = call i1 @_FortranAioOutputAscii(ptr %145, ptr %16, i64 %28)
  %147 = call i32 @_FortranAioEndIoStatement(ptr %145)
  %148 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX282720202020464C494E4B464C4147532020203D20272C206129, i64 26, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 113)
  %149 = call i1 @_FortranAioOutputAscii(ptr %148, ptr %17, i64 %29)
  %150 = call i32 @_FortranAioEndIoStatement(ptr %148)
  %151 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX28272020202052414E442020202020202020203D20272C206129, i64 26, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 116)
  %152 = call i1 @_FortranAioOutputAscii(ptr %151, ptr %18, i64 %30)
  %153 = call i32 @_FortranAioEndIoStatement(ptr %151)
  %154 = call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclXb976bf930fdd5cc64607d5cbc6346625, i64 92, ptr null, i32 6, ptr nonnull @_QQclXc3ab84a7c9a8ec0a0996dd14d13b3f65, i32 119)
