...
define void @ssor_(ptr nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %18 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEa, i64 20400, ptr nonnull @_QMlu_dataEa.cache)
  %19 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEb, i64 20400, ptr nonnull @_QMlu_dataEb.cache)
  %20 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEc, i64 20400, ptr nonnull @_QMlu_dataEc.cache)
  %21 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEd, i64 20400, ptr nonnull @_QMlu_dataEd.cache)
  %22 = alloca [5 x double], align 8
  %23 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEflux, i64 4080, ptr nonnull @_QMlu_dataEflux.cache)
...
omp.par.entry:
  ...
  %30 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num148, ptr nonnull @_QMlu_dataEa, i64 20400, ptr nonnull @_QMlu_dataEa.cache)
  %31 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num148, ptr nonnull @_QMlu_dataEb, i64 20400, ptr nonnull @_QMlu_dataEb.cache)
  %32 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num148, ptr nonnull @_QMlu_dataEc, i64 20400, ptr nonnull @_QMlu_dataEc.cache)
  %33 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num148, ptr nonnull @_QMlu_dataEd, i64 20400, ptr nonnull @_QMlu_dataEd.cache)
