...
define void @ssor_(ptr nocapture readonly %0) local_unnamed_addr #0 {
  ...
  %18 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEa, i64 32400, ptr nonnull @_QMlu_dataEa.cache)
  %19 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEb, i64 32400, ptr nonnull @_QMlu_dataEb.cache)
  %20 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEc, i64 32400, ptr nonnull @_QMlu_dataEc.cache)
  %21 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEd, i64 32400, ptr nonnull @_QMlu_dataEd.cache)
  %22 = alloca [5 x double], align 8
  %23 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num5, ptr nonnull @_QMlu_dataEflux, i64 6480, ptr nonnull @_QMlu_dataEflux.cache)
...
omp.par.entry:
  ...
  %30 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num148, ptr nonnull @_QMlu_dataEa, i64 32400, ptr nonnull @_QMlu_dataEa.cache)
  %31 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num148, ptr nonnull @_QMlu_dataEb, i64 32400, ptr nonnull @_QMlu_dataEb.cache)
  %32 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num148, ptr nonnull @_QMlu_dataEc, i64 32400, ptr nonnull @_QMlu_dataEc.cache)
  %33 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num148, ptr nonnull @_QMlu_dataEd, i64 32400, ptr nonnull @_QMlu_dataEd.cache)
...
omp_loop.body122:                                 ; preds = %omp.par.region11, %omp_loop.body122
  ...
  store i32 162, ptr %8, align 4, !tbaa !10
  store i32 162, ptr %7, align 4, !tbaa !10
...
omp.par.region8:                                  ; preds = %omp.par.region8.preheader, %omp_loop.exit137
  ...
  store i32 162, ptr %23, align 4, !tbaa !10
  store i32 162, ptr %22, align 4, !tbaa !10
  store i32 162, ptr %21, align 4, !tbaa !10
