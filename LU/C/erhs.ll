...
omp.par.entry:
  ...
  %0 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num244, ptr nonnull @_QMlu_dataEflux, i64 6480, ptr nonnull @_QMlu_dataEflux.cache)
