...
@_QMlu_dataEa = global [162 x [5 x [5 x double]]] zeroinitializer
@_QMlu_dataEb = global [162 x [5 x [5 x double]]] zeroinitializer
@_QMlu_dataEc = global [162 x [5 x [5 x double]]] zeroinitializer
...
@_QMlu_dataEd = global [162 x [5 x [5 x double]]] zeroinitializer
...
@_QMlu_dataEflux = global [162 x [5 x double]] zeroinitializer
...
@_QMlu_dataECisiz1 = local_unnamed_addr constant i32 162
@_QMlu_dataECisiz2 = local_unnamed_addr constant i32 162
@_QMlu_dataECisiz3 = local_unnamed_addr constant i32 162
...
define void @alloc_space_() local_unnamed_addr #0 {
  ...
  %7 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEu, i32 1, i64 1, i64 163)
  %8 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEu, i32 2, i64 1, i64 163)
  %9 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEu, i32 3, i64 1, i64 162)
...
12:                                               ; preds = %0
  ...
  %14 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErsd, i32 1, i64 1, i64 163)
  %15 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErsd, i32 2, i64 1, i64 163)
  %16 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErsd, i32 3, i64 1, i64 162)
...
19:                                               ; preds = %12
  ...
  %21 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEfrct, i32 1, i64 1, i64 163)
  %22 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEfrct, i32 2, i64 1, i64 163)
  %23 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEfrct, i32 3, i64 1, i64 162)
...
26:                                               ; preds = %19
  %27 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEqs, i32 0, i64 1, i64 163)
  %28 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEqs, i32 1, i64 1, i64 163)
  %29 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEqs, i32 2, i64 1, i64 162)
...
32:                                               ; preds = %26
  %33 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErho_i, i32 0, i64 1, i64 163)
  %34 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErho_i, i32 1, i64 1, i64 163)
  %35 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErho_i, i32 2, i64 1, i64 162)
...
38:                                               ; preds = %32
  %39 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEphi1, i32 0, i64 0, i64 163)
  %40 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEphi1, i32 1, i64 0, i64 163)
...
43:                                               ; preds = %38
  %44 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEphi2, i32 0, i64 0, i64 163)
  %45 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEphi2, i32 1, i64 0, i64 163)
