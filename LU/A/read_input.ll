...
75:                                               ; preds = %17
  ...
  store i32 250, ptr @_QMlu_dataEinorm, align 4, !tbaa !16
  store i32 250, ptr @_QMlu_dataEitmax, align 4, !tbaa !18
  store double 2.000000e+00, ptr @_QMlu_dataEdt, align 8, !tbaa !20
  ...
  store i32 64, ptr @_QMlu_dataEnx0, align 4, !tbaa !4
  store i32 64, ptr @_QMlu_dataEny0, align 4, !tbaa !10
  store i32 64, ptr @_QMlu_dataEnz0, align 4, !tbaa !12
  br label %76

76:                                               ; preds = %20, %75
  %77 = phi i32 [ %.pre8, %20 ], [ 64, %75 ]
  %78 = phi i32 [ %.pre7, %20 ], [ 64, %75 ]
  %79 = phi i32 [ %.pre, %20 ], [ 64, %75 ]
...
89:                                               ; preds = %76
  %90 = icmp ugt i32 %79, 64
  %91 = icmp ugt i32 %78, 64
  %92 = or i1 %90, %91
  %93 = icmp ugt i32 %77, 64
  %94 = or i1 %92, %93
