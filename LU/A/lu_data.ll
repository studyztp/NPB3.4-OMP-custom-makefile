...
@_QMlu_dataEa = global [64 x [5 x [5 x double]]] zeroinitializer
@_QMlu_dataEb = global [64 x [5 x [5 x double]]] zeroinitializer
@_QMlu_dataEc = global [64 x [5 x [5 x double]]] zeroinitializer
...
@_QMlu_dataEd = global [64 x [5 x [5 x double]]] zeroinitializer
...
@_QMlu_dataEflux = global [64 x [5 x double]] zeroinitializer
...
@_QMlu_dataECisiz1 = local_unnamed_addr constant i32 64
@_QMlu_dataECisiz2 = local_unnamed_addr constant i32 64
@_QMlu_dataECisiz3 = local_unnamed_addr constant i32 64
...
define void @alloc_space_() local_unnamed_addr #0 {
  ...
  %1 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMlu_dataEa, i64 12800, ptr nonnull @_QMlu_dataEa.cache)
  %2 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMlu_dataEb, i64 12800, ptr nonnull @_QMlu_dataEb.cache)
  %3 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMlu_dataEc, i64 12800, ptr nonnull @_QMlu_dataEc.cache)
  %4 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMlu_dataEd, i64 12800, ptr nonnull @_QMlu_dataEd.cache)
  %5 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMlu_dataEflux, i64 2560, ptr nonnull @_QMlu_dataEflux.cache)
  %6 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEu, i32 0, i64 1, i64 5)
  %7 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEu, i32 1, i64 1, i64 65)
  %8 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEu, i32 2, i64 1, i64 65)
  %9 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEu, i32 3, i64 1, i64 64)
...
12:                                               ; preds = %0
  ...
  %14 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErsd, i32 1, i64 1, i64 65)
  %15 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErsd, i32 2, i64 1, i64 65)
  %16 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErsd, i32 3, i64 1, i64 64)
...
19:                                               ; preds = %12
  ...
  %21 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEfrct, i32 1, i64 1, i64 65)
  %22 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEfrct, i32 2, i64 1, i64 65)
  %23 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEfrct, i32 3, i64 1, i64 64)
...
26:                                               ; preds = %19
  %27 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEqs, i32 0, i64 1, i64 65)
  %28 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEqs, i32 1, i64 1, i64 65)
  %29 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEqs, i32 2, i64 1, i64 64)
...
32:                                               ; preds = %26
  %33 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErho_i, i32 0, i64 1, i64 65)
  %34 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErho_i, i32 1, i64 1, i64 65)
  %35 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataErho_i, i32 2, i64 1, i64 64)
...
38:                                               ; preds = %32
  %39 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEphi1, i32 0, i64 0, i64 65)
  %40 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEphi1, i32 1, i64 0, i64 65)
...
43:                                               ; preds = %38
  %44 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEphi2, i32 0, i64 0, i64 65)
  %45 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMlu_dataEphi2, i32 1, i64 0, i64 65)
