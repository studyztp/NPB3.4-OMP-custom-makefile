...
@_QMft_dataEu = external global [2049 x { double, double }]
...
ilog2_.exit.thread.i:                             ; preds = %.preheader.i.i
  ...
  store double 0.000000e+00, ptr getelementptr inbounds ([2049 x { double, double }], ptr @_QMft_dataEu, i64 0, i64 0, i32 1), align 8, !tbaa !37
...
vector.scevcheck:                                 ; preds = %.lr.ph.preheader.i
  ...
  %scevgep = getelementptr i8, ptr getelementptr ([2049 x { double, double }], ptr @_QMft_dataEu, i64 -1, i64 2048, i32 0), i64 %104
  %mul.result = shl nsw i64 %97, 4
  %105 = getelementptr i8, ptr %scevgep, i64 %mul.result
  %106 = icmp ult ptr %105, %scevgep
  %scevgep585 = getelementptr i8, ptr getelementptr ([2049 x { double, double }], ptr @_QMft_dataEu, i64 -1, i64 2048, i32 1), i64 %104
...
vector.scevcheck592:                              ; preds = %.lr.ph.preheader.i530
  ...
  %scevgep594 = getelementptr i8, ptr getelementptr ([2049 x { double, double }], ptr @_QMft_dataEu, i64 -1, i64 2048, i32 0), i64 %188
  %mul.result596 = shl nsw i64 %181, 4
  %189 = getelementptr i8, ptr %scevgep594, i64 %mul.result596
  %190 = icmp ult ptr %189, %scevgep594
  %scevgep598 = getelementptr i8, ptr getelementptr ([2049 x { double, double }], ptr @_QMft_dataEu, i64 -1, i64 2048, i32 1), i64 %188
...
._crit_edge:                                      ; preds = %250, %222
  store i32 2048, ptr %21, align 4, !tbaa !4
  store i32 1024, ptr %20, align 4, !tbaa !4
  store i32 1024, ptr %19, align 4, !tbaa !4
...
257:                                              ; preds = %._crit_edge
  ...
  %260 = fmul contract double %259, 0x406405E9CD3317EB
  %261 = fadd contract double %260, 0x40652E5E5224676E
  %262 = fmul contract double %261, 0x40A0C6F7A0B5ED8D
...
264:                                              ; preds = %._crit_edge, %257
  ...
  store i32 2048, ptr %15, align 4, !tbaa !4
  store i32 1024, ptr %14, align 4, !tbaa !4
  store i32 1024, ptr %13, align 4, !tbaa !4
...
.lr.ph.i13:                                       ; preds = %4, %.backedge.i15
  %.06.i14 = phi i32 [ %.0.be.i16, %.backedge.i15 ], [ 4194304, %4 ]
  %14 = and i32 %.06.i14, 1
  %15 = icmp eq i32 %14, 0
...
omp.wsloop.region4:                               ; preds = %omp.wsloop.region4.lr.ph, %omp.wsloop.region4
  ...
  store i32 4096, ptr %4, align 4, !tbaa !84
...
define void @setup_() local_unnamed_addr #0 {
  ...
  %4 = tail call i1 @_FortranAioOutputInteger32(ptr %3, i32 2048)
  %5 = tail call i1 @_FortranAioOutputInteger32(ptr %3, i32 1024)
  %6 = tail call i1 @_FortranAioOutputInteger32(ptr %3, i32 1024)
  ...
  store i32 2048, ptr @_QMft_dataEdims, align 4, !tbaa !107
  store i32 1024, ptr getelementptr inbounds ([3 x i32], ptr @_QMft_dataEdims, i64 0, i64 1), align 4, !tbaa !107
  store i32 1024, ptr getelementptr inbounds ([3 x i32], ptr @_QMft_dataEdims, i64 0, i64 2), align 4, !tbaa !107
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %47 = add <2 x i32> %vec.ind, <i32 1023, i32 1023>
  %48 = srem <2 x i32> %47, <i32 2048, i32 2048>
  %49 = add nsw <2 x i32> %48, <i32 -1024, i32 -1024>
...
vector.scevcheck:                                 ; preds = %.lr.ph.preheader
  ...
  %28 = shl nsw i64 %27, 4
  %scevgep = getelementptr i8, ptr getelementptr ([2049 x { double, double }], ptr @_QMft_dataEu, i64 -1, i64 2048, i32 0), i64 %28
  %mul.result = shl nsw i64 %21, 4
  %29 = getelementptr i8, ptr %scevgep, i64 %mul.result
  %30 = icmp ult ptr %29, %scevgep
  %scevgep28 = getelementptr i8, ptr getelementptr ([2049 x { double, double }], ptr @_QMft_dataEu, i64 -1, i64 2048, i32 1), i64 %28
...
entry:
  ...
  %16 = call { double, double } @__divdc3(double %.fca.0.load, double %.fca.1.load, double 0x41E0000000000000, double 0.000000e+00)
