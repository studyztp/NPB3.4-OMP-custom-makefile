...
._crit_edge:                                      ; preds = %250, %222
  ...
  store i32 256, ptr %19, align 4, !tbaa !4
...
257:                                              ; preds = %._crit_edge
  ...
  %260 = fmul contract double %259, 0x40604639B26302C6
  %261 = fadd contract double %260, 0x406170A3B80CD78A
  %262 = fmul contract double %261, 0x4040C6F7A0B5ED8D
...
264:                                              ; preds = %._crit_edge, %257
  ...
  store i32 256, ptr %13, align 4, !tbaa !4
...
.lr.ph.i13:                                       ; preds = %4, %.backedge.i15
  %.06.i14 = phi i32 [ %.0.be.i16, %.backedge.i15 ], [ 262144, %4 ]
  %14 = and i32 %.06.i14, 1
  %15 = icmp eq i32 %14, 0
...
define void @setup_() local_unnamed_addr #0 {
  ...
  %5 = tail call i1 @_FortranAioOutputInteger32(ptr %3, i32 256)
  %6 = tail call i1 @_FortranAioOutputInteger32(ptr %3, i32 256)
  ...
  store i32 256, ptr getelementptr inbounds ([3 x i32], ptr @_QMft_dataEdims, i64 0, i64 1), align 4, !tbaa !107
  store i32 256, ptr getelementptr inbounds ([3 x i32], ptr @_QMft_dataEdims, i64 0, i64 2), align 4, !tbaa !107
...
entry:
  ...
  %16 = call { double, double } @__divdc3(double %.fca.0.load, double %.fca.1.load, double 0x4180000000000000, double 0.000000e+00)
