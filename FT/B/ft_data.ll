...
@_QMft_dataECntotal_f = local_unnamed_addr constant double 0x4180000000000000
@_QMft_dataECntotalp = local_unnamed_addr constant i32 33619968
...
@_QMft_dataECny = local_unnamed_addr constant i32 256
@_QMft_dataECnz = local_unnamed_addr constant i32 256
...
define void @alloc_space_() local_unnamed_addr #0 {
  %1 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu0, i32 0, i64 1, i64 33619968)
...
8:                                                ; preds = %4
  %9 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu1, i32 0, i64 1, i64 33619968)
...
16:                                               ; preds = %12
  %17 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEtwiddle, i32 0, i64 1, i64 33619968)
