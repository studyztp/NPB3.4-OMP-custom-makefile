...
@_QMft_dataECmaxdim = local_unnamed_addr constant i32 256
@_QMft_dataEniter = local_unnamed_addr global i32 0
@_QMft_dataECniter_default = local_unnamed_addr constant i32 6
@_QMft_dataECnpbversion = local_unnamed_addr constant [5 x i8] c"3.4.2"
@_QMft_dataECntotal_f = local_unnamed_addr constant double 0x4160000000000000
@_QMft_dataECntotalp = local_unnamed_addr constant i32 8421376
@_QMft_dataECnx = local_unnamed_addr constant i32 256
@_QMft_dataECnx_f = local_unnamed_addr constant double 2.560000e+02
@_QMft_dataECnxp = local_unnamed_addr constant i32 257
@_QMft_dataECny = local_unnamed_addr constant i32 256
@_QMft_dataECnz = local_unnamed_addr constant i32 128
...
@_QMft_dataEsums = local_unnamed_addr global [7 x { double, double }] zeroinitializer
...
@_QMft_dataEu = local_unnamed_addr global [257 x { double, double }] zeroinitializer
...
define void @alloc_space_() local_unnamed_addr #0 {
  %1 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu0, i32 0, i64 1, i64 8421376)
...
8:                                                ; preds = %4
  %9 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu1, i32 0, i64 1, i64 8421376)
...
16:                                               ; preds = %12
  %17 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEtwiddle, i32 0, i64 1, i64 8421376)
