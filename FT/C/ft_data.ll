...
@_QMft_dataECkind2 = local_unnamed_addr constant i32 4
@_QMft_dataECmaxdim = local_unnamed_addr constant i32 512
@_QMft_dataEniter = local_unnamed_addr global i32 0
@_QMft_dataECniter_default = local_unnamed_addr constant i32 20
@_QMft_dataECnpbversion = local_unnamed_addr constant [5 x i8] c"3.4.2"
@_QMft_dataECntotal_f = local_unnamed_addr constant double 0x41A0000000000000
@_QMft_dataECntotalp = local_unnamed_addr constant i32 134479872
@_QMft_dataECnx = local_unnamed_addr constant i32 512
@_QMft_dataECnx_f = local_unnamed_addr constant double 5.120000e+02
@_QMft_dataECnxp = local_unnamed_addr constant i32 513
@_QMft_dataECny = local_unnamed_addr constant i32 512
@_QMft_dataECnz = local_unnamed_addr constant i32 512
...
@_QMft_dataEsums = local_unnamed_addr global [21 x { double, double }] zeroinitializer
...
@_QMft_dataEu = local_unnamed_addr global [513 x { double, double }] zeroinitializer
...
define void @alloc_space_() local_unnamed_addr #0 {
  %1 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu0, i32 0, i64 1, i64 134479872)
...
8:                                                ; preds = %4
  %9 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu1, i32 0, i64 1, i64 134479872)
...
16:                                               ; preds = %12
  %17 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEtwiddle, i32 0, i64 1, i64 134479872)
