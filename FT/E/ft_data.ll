...
@_QMft_dataECmaxdim = local_unnamed_addr constant i32 4096
...
@_QMft_dataECntotal_f = local_unnamed_addr constant double 0x4210000000000000
@_QMft_dataECntotalp = local_unnamed_addr constant i64 17184063488
@_QMft_dataECnx = local_unnamed_addr constant i32 4096
@_QMft_dataECnx_f = local_unnamed_addr constant double 4.096000e+03
@_QMft_dataECnxp = local_unnamed_addr constant i64 4097
@_QMft_dataECny = local_unnamed_addr constant i32 2048
@_QMft_dataECnz = local_unnamed_addr constant i32 2048
...
@_QMft_dataEu = local_unnamed_addr global [4097 x { double, double }] zeroinitializer
...
define void @alloc_space_() local_unnamed_addr #0 {
  %1 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu0, i32 0, i64 1, i64 17184063488)
...
8:                                                ; preds = %4
  %9 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEu1, i32 0, i64 1, i64 17184063488)
...
16:                                               ; preds = %12
  %17 = tail call {} @_FortranAAllocatableSetBounds(ptr nonnull @_QMft_fieldsEtwiddle, i32 0, i64 1, i64 17184063488)
