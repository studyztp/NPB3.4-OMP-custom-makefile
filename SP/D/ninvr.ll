...
define void @ninvr_() local_unnamed_addr #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %omp_global_thread_num4 = tail call i32 @__kmpc_global_thread_num(ptr nonnull @1)
  %3 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMsp_dataEbuf, i64 16320, ptr nonnull @_QMsp_dataEbuf.cache)
  %4 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMsp_dataEcuf, i64 3264, ptr nonnull @_QMsp_dataEcuf.cache)
  %5 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMsp_dataEq, i64 3264, ptr nonnull @_QMsp_dataEq.cache)
  %6 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMsp_dataEue, i64 16320, ptr nonnull @_QMsp_dataEue.cache)
...
omp_parallel:                                     ; preds = %8, %0
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr nonnull @1, i32 0, ptr nonnull @ninvr_..omp_par)
...
define internal void @ninvr_..omp_par(ptr noalias nocapture readnone %tid.addr, ptr noalias nocapture readnone %zero.addr) #1 {
omp.par.entry:
...
omp.wsloop.region19.us:                           ; preds = %omp_collapsed.body.us, %omp.wsloop.region19.us
  ...
  %38 = fmul contract double %33, %10
  %39 = fadd contract double %35, %37
  %40 = fmul contract double %39, 5.000000e-01
  %41 = fneg contract double %31
  store double %41, ptr %28, align 8, !tbaa !17
  store double %29, ptr %30, align 8, !tbaa !17
  %42 = fsub contract double %35, %37
  %43 = fmul contract double %10, %42
  store double %43, ptr %32, align 8, !tbaa !17
...
!9 = !{!"Flang function root _QPninvr"}
!10 = !{!7, !7, i64 0}
!11 = !{!12, !12, i64 0}
