...
@_QMwork_lhsEcv = local_unnamed_addr global [162 x double] zeroinitializer
@_QMwork_lhsECimaxp = local_unnamed_addr constant i32 162
@_QMwork_lhsElhs = local_unnamed_addr global [163 x [5 x double]] zeroinitializer
@_QMwork_lhsElhsm = local_unnamed_addr global [163 x [5 x double]] zeroinitializer
@_QMwork_lhsElhsp = local_unnamed_addr global [163 x [5 x double]] zeroinitializer
@_QMwork_lhsErhov = local_unnamed_addr global [162 x double] zeroinitializer
