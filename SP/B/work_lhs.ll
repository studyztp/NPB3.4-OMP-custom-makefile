...
@_QMwork_lhsEcv = local_unnamed_addr global [102 x double] zeroinitializer
@_QMwork_lhsECimaxp = local_unnamed_addr constant i32 102
@_QMwork_lhsElhs = local_unnamed_addr global [103 x [5 x double]] zeroinitializer
@_QMwork_lhsElhsm = local_unnamed_addr global [103 x [5 x double]] zeroinitializer
@_QMwork_lhsElhsp = local_unnamed_addr global [103 x [5 x double]] zeroinitializer
@_QMwork_lhsErhov = local_unnamed_addr global [102 x double] zeroinitializer
