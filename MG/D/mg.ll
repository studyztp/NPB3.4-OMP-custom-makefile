...
@_QMmg_dataEir = external local_unnamed_addr global [11 x i32]
...
@_QMmg_dataEm1 = external global [11 x i32]
@_QMmg_dataEm2 = external global [11 x i32]
@_QMmg_dataEm3 = external global [11 x i32]
@_QMmg_dataEnx = external global [11 x i32]
@_QMmg_dataEny = external global [11 x i32]
@_QMmg_dataEnz = external global [11 x i32]
@_QMmg_fieldsEr = external local_unnamed_addr global { ptr, i64, i32, i8, i8, i8, i8, [1 x [3 x i64]] }
@_QMmg_dataEstarts = external local_unnamed_addr global [1026 x double]
...
106:                                              ; preds = %67
  ...
  store i32 10, ptr @_QMmg_dataElt, align 4, !tbaa !13
  store i32 50, ptr %32, align 4, !tbaa !4
  store i32 1024, ptr getelementptr inbounds ([11 x i32], ptr @_QMmg_dataEnx, i64 0, i64 9), align 4, !tbaa !15
  store i32 1024, ptr getelementptr inbounds ([11 x i32], ptr @_QMmg_dataEny, i64 0, i64 9), align 4, !tbaa !17
  store i32 1024, ptr getelementptr inbounds ([11 x i32], ptr @_QMmg_dataEnz, i64 0, i64 9), align 4, !tbaa !19
...
.thread:                                          ; preds = %.lr.ph21, %middle.block65, %.preheader, %.loopexit
  ...
  %124 = getelementptr i32, ptr @_QMmg_dataEir, i64 %7
  %125 = getelementptr i8, ptr %124, i64 -4
  store i32 1, ptr %125, align 4, !tbaa !92
...
vector.scevcheck88:                               ; preds = %.lr.ph25.preheader
  ...
  %scevgep98 = getelementptr i8, ptr %140, i64 -4
  %mul.result100.neg = mul nsw i64 %126, -4
...
vector.memcheck:                                  ; preds = %vector.scevcheck88
  ...
  %147 = and i64 %146, 4611686018427387900
...
vector.body111:                                   ; preds = %vector.body111, %vector.ph105
  ...
  %gep138 = getelementptr i32, ptr getelementptr (i8, ptr @_QMmg_dataEir, i64 -12), i64 %151
  %wide.load = load <4 x i32>, ptr %gep138, align 4, !tbaa !92
  ...
  %152 = mul <4 x i32> %wide.load117, %wide.load115
  ...
  %153 = mul <4 x i32> %152, %wide.load119
  %154 = add <4 x i32> %153, %wide.load
  %155 = shl i64 %offset.idx113, 32
  %156 = ashr exact i64 %155, 32
  %gep142 = getelementptr i32, ptr getelementptr (i8, ptr getelementptr ([11 x i32], ptr @_QMmg_dataEir, i64 -1, i64 10), i64 -12), i64 %156
  store <4 x i32> %154, ptr %gep142, align 4, !tbaa !92
  %index.next122 = add nuw i64 %index112, 4
  %157 = icmp eq i64 %index.next122, %n.vec107
  br i1 %157, label %middle.block102, label %vector.body111, !llvm.loop !94
...
.lr.ph25:                                         ; preds = %.lr.ph25.preheader123, %.lr.ph25
  %158 = phi i64 [ %174, %.lr.ph25 ], [ %.ph, %.lr.ph25.preheader123 ]
  %159 = shl i64 %158, 32
  %sext45 = add i64 %159, 4294967296
  %160 = ashr exact i64 %sext45, 32
  %161 = add nsw i64 %160, -1
  %162 = getelementptr i32, ptr @_QMmg_dataEir, i64 %161
  %163 = load i32, ptr %162, align 4, !tbaa !92
  %164 = getelementptr i32, ptr @_QMmg_dataEm1, i64 %161
  %165 = load i32, ptr %164, align 4, !tbaa !63
  %166 = getelementptr i32, ptr @_QMmg_dataEm2, i64 %161
  %167 = load i32, ptr %166, align 4, !tbaa !65
  %168 = mul i32 %167, %165
  %169 = getelementptr i32, ptr @_QMmg_dataEm3, i64 %161
  %170 = load i32, ptr %169, align 4, !tbaa !67
  %171 = mul i32 %168, %170
  %172 = add i32 %171, %163
  %sext46 = shl i64 %158, 32
  %173 = ashr exact i64 %sext46, 32
  %gep = getelementptr i32, ptr getelementptr ([11 x i32], ptr @_QMmg_dataEir, i64 -1, i64 10), i64 %173
  store i32 %172, ptr %gep, align 4, !tbaa !92
  %174 = add nsw i64 %158, -1
  %175 = icmp sgt i64 %158, 1
  br i1 %175, label %.lr.ph25, label %._crit_edge26, !llvm.loop !95

._crit_edge26:                                    ; preds = %.lr.ph25, %middle.block102, %.thread
  %176 = load i32, ptr getelementptr inbounds ([8 x i32], ptr @_QMmg_dataEdebug_vec, i64 0, i64 1), align 4, !tbaa !96
  %177 = icmp sgt i32 %176, 0
  br i1 %177, label %178, label %231

178:                                              ; preds = %._crit_edge26
  %179 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclX943e47e85b2058b7b53be6abb129eb90, i32 428)
  %180 = tail call i1 @_FortranAioOutputAscii(ptr %179, ptr nonnull @_QQclX20696E2073657475702C20, i64 11)
  %181 = tail call i32 @_FortranAioEndIoStatement(ptr %179)
  %182 = tail call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclX943e47e85b2058b7b53be6abb129eb90, i32 429)
  %183 = tail call i1 @_FortranAioOutputAscii(ptr %182, ptr nonnull @_QQclX206B20206C7420206E7820206E7920206E7A20, i64 19)
  %184 = tail call i1 @_FortranAioOutputAscii(ptr %182, ptr nonnull @_QQclXfbe80427905b9bec3b4d8d2331eaa68a, i64 35)
  %185 = tail call i32 @_FortranAioEndIoStatement(ptr %182)
  %186 = tail call ptr @_FortranAioBeginExternalFormattedOutput(ptr nonnull @_QQclX283135693429, i64 6, ptr null, i32 6, ptr nonnull @_QQclX943e47e85b2058b7b53be6abb129eb90, i32 431)
  %187 = load i32, ptr %3, align 4, !tbaa !71
  %188 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %187)
  %189 = load i32, ptr @_QMmg_dataElt, align 4, !tbaa !46
  %190 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %189)
  %191 = load i32, ptr %3, align 4, !tbaa !71
  ...
  %197 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %196)
  %198 = load i32, ptr %3, align 4, !tbaa !71
  %199 = sext i32 %198 to i64
  %200 = mul nsw i64 %199, 3
  %201 = getelementptr i32, ptr %5, i64 %200
  %202 = getelementptr i8, ptr %201, i64 -8
  %203 = load i32, ptr %202, align 4, !tbaa !54
  %204 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %203)
  %205 = load i32, ptr %3, align 4, !tbaa !71
  %206 = sext i32 %205 to i64
  %207 = mul nsw i64 %206, 3
  %208 = getelementptr i32, ptr %5, i64 %207
  %209 = getelementptr i8, ptr %208, i64 -4
  %210 = load i32, ptr %209, align 4, !tbaa !54
  %211 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %210)
  %212 = load i32, ptr %0, align 4, !tbaa !78
  %213 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %212)
  %214 = load i32, ptr %1, align 4, !tbaa !84
  %215 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %214)
  %216 = load i32, ptr %2, align 4, !tbaa !90
  %217 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %216)
  %218 = load i32, ptr @_QMmg_dataEis1, align 4, !tbaa !74
  %219 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %218)
  %220 = load i32, ptr @_QMmg_dataEis2, align 4, !tbaa !80
  %221 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %220)
  %222 = load i32, ptr @_QMmg_dataEis3, align 4, !tbaa !86
  %223 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %222)
  %224 = load i32, ptr @_QMmg_dataEie1, align 4, !tbaa !76
  %225 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %224)
  %226 = load i32, ptr @_QMmg_dataEie2, align 4, !tbaa !82
  %227 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %226)
  %228 = load i32, ptr @_QMmg_dataEie3, align 4, !tbaa !88
  %229 = tail call i1 @_FortranAioOutputInteger32(ptr %186, i32 %228)
  %230 = tail call i32 @_FortranAioEndIoStatement(ptr %186)
  %.pre = load i32, ptr @_QMmg_dataElt, align 4, !tbaa !46
  br label %231

231:                                              ; preds = %178, %._crit_edge26
  %232 = phi i32 [ %.pre, %178 ], [ %6, %._crit_edge26 ]
  store i32 %232, ptr %3, align 4, !tbaa !71
  ret void
}
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %9
  ...
  store i32 %42, ptr %8, align 4, !tbaa !106
  ...
  %74 = load i32, ptr @_QMmg_dataElb, align 4, !tbaa !104
  %75 = add i32 %74, 1
  %76 = sext i32 %75 to i64
  %77 = load i32, ptr @_QMmg_dataElt, align 4, !tbaa !98
  %78 = add i32 %77, -1
...
82:                                               ; preds = %.lr.ph25, %82
  ...
  store i32 %84, ptr %8, align 4, !tbaa !106
  %85 = add i32 %84, -1
  ...
  %111 = load i32, ptr %8, align 4, !tbaa !106
  ...
  %120 = load i32, ptr %8, align 4, !tbaa !106
  ...
  %132 = load i32, ptr %8, align 4, !tbaa !106
  ...
  %144 = load i32, ptr %8, align 4, !tbaa !106
  %145 = add i32 %144, 1
...
._crit_edge26:                                    ; preds = %._crit_edge26.loopexit, %._crit_edge
  ...
  store i32 %148, ptr %8, align 4, !tbaa !106
...
omp.par.entry:
  ...
  %5 = alloca [1027 x double], align 8
  %6 = alloca [1027 x double], align 8
...
omp.par.entry:
  ...
  %p.upperbound = alloca i32, align 4
  %p.stride = alloca i32, align 4
  %7 = alloca [1027 x double], align 8
  %8 = alloca [1027 x double], align 8
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %gep = getelementptr double, ptr getelementptr ([1026 x double], ptr @_QMmg_dataEstarts, i64 -1, i64 1025), i64 %indvars.iv
