...
@key_array = dso_local local_unnamed_addr global [33554432 x i32] zeroinitializer, align 4
@key_buff1 = dso_local global [2097152 x i32] zeroinitializer, align 4
@key_buff2 = dso_local global [33554432 x i32] zeroinitializer, align 4
...
define internal void @alloc_key_buff.omp_outlined(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1) #4 {
  ...
  store i32 33554431, ptr %4, align 4, !tbaa !7
...
define internal void @full_verify.omp_outlined.1(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1, ptr nocapture noundef nonnull align 4 dereferenceable(4) %2) #4 {
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %5) #6
  store i32 33554430, ptr %5, align 4, !tbaa !7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %6) #6
...
define dso_local void @rank(i32 noundef %0) local_unnamed_addr #3 {
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %5) #6
  store i32 2048, ptr %5, align 4, !tbaa !7
  %6 = sext i32 %0 to i64
...
define internal void @rank.omp_outlined(ptr noalias nocapture noundef readonly %0, ptr noalias nocapture readnone %1, ptr nocapture noundef nonnull readonly align 4 dereferenceable(4) %2, ptr nocapture noundef nonnull readonly align 4 dereferenceable(4) %3, ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) %4, ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) %5) #4 {
  ...
  store i32 0, ptr %7, align 4, !tbaa !7
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %8) #6
  store i32 33554431, ptr %8, align 4, !tbaa !7
...
97:                                               ; preds = %93
  ...
  store i32 33554431, ptr %12, align 4, !tbaa !7
  ...
  %99 = call i32 @llvm.smin.i32(i32 %98, i32 33554431)
...
104:                                              ; preds = %102, %104
  ...
  %106 = getelementptr inbounds [33554432 x i32], ptr @key_array, i64 0, i64 %105
  ...
  %115 = getelementptr inbounds [33554432 x i32], ptr @key_buff2, i64 0, i64 %114
...
11:                                               ; preds = %2
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) @test_index_array, ptr noundef nonnull align 4 dereferenceable(20) @B_test_index_array, i64 20, i1 false), !tbaa !7
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) @test_rank_array, ptr noundef nonnull align 4 dereferenceable(20) @B_test_rank_array, i64 20, i1 false), !tbaa !7
