...
$_QQclXe15959ab4318f43ed3835fe35f3208c7 = comdat any
...
@_QQclXe15959ab4318f43ed3835fe35f3208c7 = linkonce constant [59 x i8] c"/scr/studyztp/test/NPB3.4-OMP-custom-makefile/BT/error.f90\00", comdat
...
omp_parallel:
  ...
  %1 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMbt_dataEbuf, i64 40840, ptr nonnull @_QMbt_dataEbuf.cache)
  %2 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMbt_dataEcuf, i64 8168, ptr nonnull @_QMbt_dataEcuf.cache)
  %3 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMbt_dataEq, i64 8168, ptr nonnull @_QMbt_dataEq.cache)
  %4 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num4, ptr nonnull @_QMbt_dataEue, i64 40840, ptr nonnull @_QMbt_dataEue.cache)
...
omp.par.entry:
  ...
  %13 = call {} @_FortranAAssign(ptr nonnull %10, ptr nonnull %9, ptr nonnull @_QQclXe15959ab4318f43ed3835fe35f3208c7, i32 24) #3
...
omp.par.entry:
  ...
  store i64 8, ptr %.fca.7.0.2.gep30, align 8
  %9 = call {} @_FortranAAssign(ptr nonnull %6, ptr nonnull %5, ptr nonnull @_QQclXe15959ab4318f43ed3835fe35f3208c7, i32 24) #3
  %10 = alloca { ptr, i64, i32, i8, i8, i8, i8, [1 x [3 x i64]] }, align 8
...
omp_collapsed.body.us:                            ; preds = %omp_collapsed.body.us.preheader, %omp.wsloop.region18.omp.wsloop.region23_crit_edge.us
  ...
  %43 = udiv i32 %.frozen, %omp_loop.tripcount6.frozen
  %44 = mul i32 %43, %omp_loop.tripcount6.frozen
  %.decomposed = sub i32 %.frozen, %44
  %45 = add i32 %43, 1
  %46 = add nuw nsw i32 %.decomposed, 1
