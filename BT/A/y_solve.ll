...
@_QMwork_lhsEfjac = external global [65 x [5 x [5 x double]]]
@_QMbt_dataEgrid_points = external local_unnamed_addr global [3 x i32]
@_QMwork_lhsElhs = external global [65 x [3 x [5 x [5 x double]]]]
@_QMwork_lhsEnjac = external global [65 x [5 x [5 x double]]]
...
define void @y_solve_() local_unnamed_addr #0 {
  ...
  %3 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num7, ptr nonnull @_QMbt_dataEbuf, i64 2600, ptr nonnull @_QMbt_dataEbuf.cache)
  %4 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num7, ptr nonnull @_QMbt_dataEcuf, i64 520, ptr nonnull @_QMbt_dataEcuf.cache)
  %5 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num7, ptr nonnull @_QMwork_lhsEfjac, i64 13000, ptr nonnull @_QMwork_lhsEfjac.cache)
  %6 = alloca i32, align 4
  %7 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num7, ptr nonnull @_QMwork_lhsElhs, i64 39000, ptr nonnull @_QMwork_lhsElhs.cache)
  %8 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num7, ptr nonnull @_QMwork_lhsEnjac, i64 13000, ptr nonnull @_QMwork_lhsEnjac.cache)
  %9 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num7, ptr nonnull @_QMbt_dataEq, i64 520, ptr nonnull @_QMbt_dataEq.cache)
  %10 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num7, ptr nonnull @_QMbt_dataEue, i64 2600, ptr nonnull @_QMbt_dataEue.cache)
...
omp.par.entry:
  ...
  %3 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num47, ptr nonnull @_QMwork_lhsEfjac, i64 13000, ptr nonnull @_QMwork_lhsEfjac.cache)
  %4 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num47, ptr nonnull @_QMwork_lhsEnjac, i64 13000, ptr nonnull @_QMwork_lhsEnjac.cache)
  %5 = tail call ptr @__kmpc_threadprivate_cached(ptr nonnull @1, i32 %omp_global_thread_num47, ptr nonnull @_QMwork_lhsElhs, i64 39000, ptr nonnull @_QMwork_lhsElhs.cache)
